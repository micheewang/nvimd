...
local plug_map = {
	...
	-- Plugin: diffview
	["n|<leader>dd"] = map_cr("DiffviewOpen"):with_silent():with_noremap():with_desc("git: Show diff"),
	["n|<leader>DD"] = map_cr("DiffviewClose"):with_silent():with_noremap():with_desc("git: Close diff"),
